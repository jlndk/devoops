...
This report consists of three parts, a description of the system in its final state when course ended, an explanation of the development process and tools used, and finally the lessons learned while developing the system.
