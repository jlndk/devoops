All CI/CD in the project is achieved using GitHub actions. We have separated different steps of the CI/CD process into different workflow files with separate responsibilities:
